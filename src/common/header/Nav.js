...
const Nav = () => {
  ...
  const [menuItems, setMenuItems] = useState([
    ...
    },
    {
      ...
      link: '#',
      submenu: [
        { label: 'Certification Program', link: '/Certification-Program' },
        { label: 'Pro Degree Program', link: '/Pro-Degree-Program' },
        { label: 'Skill Development Program', link: '/Skill-Development-Program' },
