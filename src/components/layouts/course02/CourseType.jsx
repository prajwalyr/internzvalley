        ...
        <div className={`course-grid course-style-3  ${classes ? classes : ""}`}>
            ...
            <div className="course-content">
                <div className="course-meta d-flex justify-content-between mb-20">
                    <span className="category"><Link to="https://api.whatsapp.com/send?phone=917026090443" target="_blank" className="whatsapp-link" style={{"color":"white"}}> WhatsApp</Link></span>
                ...
                <h3 className="course-title mb-20">
                    {" "}
                    <Link to={process.env.PUBLIC_URL + `/course-details-three/${data.id}`}>
                        {data.title}
                    </Link>{" "}
                </h3>
                <p className="course-desc mb-20">{data.description}</p>
                ...
                <div className="course-footer mt-20 d-flex align-items-center justify-content-between">
                    ...
                    <Link
                        to={process.env.PUBLIC_URL + `/course-details-three/${data.id}`}
